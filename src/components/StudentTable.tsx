                ...
                <tbody>
                    {students.map((item) =>(
                        <tr key={item.id} className="text-gray-600 bg-gray-400 border-b border-gray-600">
                            ...
                            <td className="p-3">
                                {item.active && <div className="px-2 py-1 inline-block rounded-md border border-green-800 bg-green-600 text-white">Active</div>}
                                {!item.active && <div className="px-2 py-1 inline-block rounded-md border border-red-800 bg-red-600 text-white">Inactive</div>}
                            </td>
